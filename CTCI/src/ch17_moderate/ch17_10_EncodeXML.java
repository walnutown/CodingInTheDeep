...
public class ch17_10_EncodeXML {
   ...
   // Similar to DescribeInteger
   // Decompose the original string into blocks and recursively parse each block
   // time: O(n)
   public String encodeXML(Element root, Map<String, String> map) {
      StringBuilder res = new StringBuilder();
      encode(root, map, res);
      return res.toString();
   }

   private void encode(Element e, Map<String, String> map, StringBuilder res) {
   ...
   // ensure whitespace after each word
