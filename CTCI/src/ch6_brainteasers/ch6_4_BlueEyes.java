...
public class ch6_4_BlueEyes {
    ...
    * (nor is anyone allowed to tell them). Additionally, they do not know how many people have blue
   ...
   // use induction
   // analyze the case:
   // <1> exact 1 person has blue eyes. The blue will leave the first night
   // <2> exact 2 people have blue eyes. Both leave on the second night
   // <3> c people have blue eyes. It will take c nights for the blue-eyed people to leave. All will
