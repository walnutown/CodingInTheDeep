...
public class ReversePolishNotation {
   ...
   /*
    * An expression consisting of operands and binary operators can be written in Reverse Polish
    * Notation (RPN) by
    * writing both the operands followed by the operator. For example, 3 + (4 * 5) can be written as
    * "3 4 5 * +".
    * You are given a string consisting of x's and *'s. x represents an operand and * represents a
    * binary operator.
    * It is easy to see that not all such strings represent valid RPN expressions. For example, the
    * "x*x" is not a valid
    * RPN expression, while "xx*" and "xxx**" are valid expressions. What is the minimum number of
    * insert, delete and
